(define (problem roversEnMarte)
  ...
  (:goal
    (and
      (forall (?b - base) (or (not(esAlmacen ?b)) (= (suministrosEnBase ?b) 0))) ; almacen implica suministrosEnBase=0, traducido logicamente
      (forall (?b - base) (or (not(esAsentamiento ?b)) (= (personasEnBase ?b) 0))) ; asentamiento implica personasEnBase=0
